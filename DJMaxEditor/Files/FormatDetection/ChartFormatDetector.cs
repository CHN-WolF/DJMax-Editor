...
namespace DJMaxEditor.Files.FormatDetection
{
    ...
    public static class ChartFormatDetector
    {
        ...
        public static FormatDetectionResult Detect(byte[] data, string extensionHint = null)
        {
            ...
            // (3b) TECHMANIA track.tech - JSON carrying patternMetadata and pipe-packed
            //      note tables. A '{' at offset 0 is never "PTFF", so the order cannot collide.
            string techEvidence;
        ...
        /// are corroboration rather than the test. The check is textual over the first
        /// megabyte, and a genuinely malformed file is left to the parser to reject.
        /// </summary>
